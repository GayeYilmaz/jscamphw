...
//console.log("---------------------------")
//userService.load()
//let customerToAdd =new Customer(1,"Seda","Yılmaz","Ankara","jdjdj")
//customerToAdd.type="customer"
//userService.add(customerToAdd)
//userService.add(new Customer(1,"Seda","Yılmaz","Ankara","jdjdj"))
//console.log("Users")
...
new UserService(logger1).load()
new CustomerService().list()
//new CustomerService().load()